  ...
  return (
    <div className="beautiful-auth-page">
      ...
      <div className="beautiful-auth-container">
        <div className="beautiful-auth-card">
          <div className="beautiful-auth-header">
            ...
            <h2>Welcome Back</h2>
            <p>Sign in to your account to continue coding</p>
          </div>



          <form onSubmit={handleSubmit} className="beautiful-auth-form">
            {error && !showNetworkStatus && (
            ...
            <div className="beautiful-form-options">
              ...
              <Link to="/forgot-password" className="beautiful-link">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="beautiful-auth-footer">
            <p>
              ...
              <Link to="/register" className="beautiful-link-primary">
                Sign up for free
              </Link>
            </p>
          </div>
